...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm]
    \clip(-1.82,-1.53) rectangle (17.58,9.17);
    \draw[line width=2pt, smooth,samples=100,domain=0:1] plot[parametric] function{(1-t)**(3)*0+3*t*(1-t)**(2)*0.5+3*t**(2)*(1-t)*3+t**(3)*4,(1-t)**(3)*0+3*t*(1-t)**(2)*4.5+3*t**(2)*(1-t)*2+t**(3)*4};
    \begin{scriptsize}
