...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm]
    \clip(-0.74,-0.93) rectangle (18.82,9.77);
    \draw[line width=2pt, smooth,samples=100,domain=0:1] plot[parametric] function{(1-t)**(2)*0+2*t*(1-t)*2+t**(2)*3,(1-t)**(2)*0+2*t*(1-t)*6+t**(2)*2};
    \begin{scriptsize}
        ...
        \draw[color=ududff] (2.16,6.42) node {$B$};
    \end{scriptsize}
\end{tikzpicture}