...
\end{equation}
where we have used equations \ref{eq:PeriasisVsSemiMajorAxisAndEcentricity} and \ref{eq:ApoasisVsSemiMajorAxisAndEcentricity} to substitute in for $a$ and $b$ respectively.
