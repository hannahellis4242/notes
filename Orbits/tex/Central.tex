...
\begin{align}
\frac{d V}{dr}&=\frac{d}{dr}(U(\infty)-U(r)\label{eq:central3}
\end{align}
...
\begin{equation}
E =\frac{1}{2} m v^2 + \int_{\infty}^{r} f(r') dr'
\end{equation}

Again it is often easier to use the specific total energy $\epsilon$

\begin{equation}
\epsilon=\frac{E}{m}=\frac{1}{2} v^2 + \int_{\infty}^{r} \frac{f(r')}{m} dr'
\end{equation}
...
&=\frac{1}{2} \frac{1}{2}\frac{d v^2}{dv}\frac{dv}{dt} + \frac{d\tilde{V}}{dr}\frac{dr}{dt} \nonumber \\
&=\frac{1}{2} \frac{1}{2}(2v)\dot{v} + \frac{f(r)}{m} v \nonumber \\
&=\frac{1}{2} v(\dot{v} + \frac{f(r)}{m}) \nonumber \\
\end{align}
